...
export class ribxzMstarv2 {
        ...
        components = {
                upload_mmcif_structure: async (
                        ...
                        asset_url = `https://files.rcsb.org/download/${rcsb_id.toUpperCase()}.cif`;
        ...
        ligands = {
                create_ligand_and_surroundings: async (chemicalId: string | undefined, radius: number) => {
                        ...
                        await this.ctx.dataTransaction(async () => {
                                const RADIUS = radius;
                                let structures = this.ctx.managers.structure.hierarchy.current.structures.map(
