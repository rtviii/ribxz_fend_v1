...
// ADd visuals provider to the  plugin
declare global {
    interface Window {
...
// async function addSpheres(ctx: PluginUIContext, spheres: Partial<{ x: number, y: number, z: number, radius: number, color: Color}>[]) {
//     ctx.builders.structure.representation.addRepresentation(structure, { type: 'cartoon' });
//     spheres.map((s) => {
//         ctx.builders.structure.representation.addRepresentation(
//             structure, {
...
//             // Register the custom visual within molstar
//             window.molstar.representation.structure.registry.add(ArbitrarySphereRepresentationProvider);

//             addSpheres(
//                 window.molstar,
//                 '3PTB',
//                 [
//                     { x: 10, y: 11, radius: 6, color: Color(0xFF0000) },
//                     { x: 10, y: 11, z: 10, radius: 6, color: Color(0x00FF11) }
//                 ]
//             );
//             addSpheres(
//                 window.molstar,
//                 '1BNA',
//                 [{ x: -10, y: -11, radius: 3, color: Color(0x1100CC) }]
//             );
