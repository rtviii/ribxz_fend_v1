        ...
        <Sheet>
            ...
            <SheetContent side={'left'} className="flex-col flex">
                <SheetHeader>
                    <SheetTitle>
                        <Link
                            className="flex items-center space-x-2 text-gray-800 hover:text-gray-600 hover:bg-muted rounded-sm"
                            href="/">
            ...
            Structures and component chains, nomenclature for polymer classes.
                ...
                <div className="grid-flow-col   bg-white  ">
                    ...
                    <Link
                        className="block py-2 px-2 font-semibold text-sm text-gray-700 hover:bg-muted rounded-sm"
                        href="/structures">
                        Structures
                    </Link>
                    ...
                    {/* <Link className=" block py-2 px-2 font-semibold  text-sm   hover:bg-muted rounded-sm" href="/ligands" > */}
                    <Link
                        className="block py-2 px-2 font-semibold  text-sm   hover:bg-muted rounded-sm"
                        href={'/ligands'}>
                        Ligand Prediction
                    </Link>
                    {/* </Link>  */}
                    ...
                    <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="item-1" className="w-full">
                            <AccordionTrigger className="p-0 m-0">
                                <span className="block py-2 px-2 font-semibold  text-sm text-gray-400  hover:bg-muted rounded-sm">
                                    Landmarks (WIP)
                                </span>
                            </AccordionTrigger>
                            ...
                            <AccordionContent>
                                ...
                                <span className="w-full py-2 px-8   text-sm   text-gray-400 hover:bg-muted rounded-md">
                                    PTC
                                </span>
                                {/* </Link> */}
                            </AccordionContent>
                ...
                <div className="flex-col  h-full   align-bottom justify-end justify-items-end content-end  ">
                    ...
                    <Link className="block py-2   text-sm " href="#">
                        {' '}
                        About (WIP){' '}
                    </Link>
                    <Link className="block py-2   text-sm " href="#">
                    ...
                    <Link className="block py-2   text-sm " href="mailto:rtkushner@gmail.com; kdd@math.ubc.ca">
                        {' '}
                        Contact{' '}
                    </Link>
                </div>
