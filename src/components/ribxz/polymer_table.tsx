...
export const PolymerTableRow = (props: PolymerTableRowProps) => {
    ...
    return <TableRow
        ...
        <TableCell className="mt-1 text-xs whitespace-pre text-center"><SequencePopover seqType={polymer.entity_poly_polymer_type === 'Protein' ? 'amino' :'rna'} sequence={polymer.entity_poly_seq_one_letter_code_can}/></TableCell>
    </TableRow>
}
