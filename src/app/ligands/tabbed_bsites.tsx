    ...
    return (
        <div className="h-[calc(100vh-200px)] flex flex-col">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-col flex-grow">
                <div className="px-4">
                    {' '}
                    {/* Container for tabs only */}
                    <TabsList className="flex-shrink-0 flex flex-row space-x-1 bg-transparent p-0 -ml-4">
                        {' '}
                        {/* Negative margin to align with edge */}
                        <TabsTrigger
                            value="source"
                            className={cn(
