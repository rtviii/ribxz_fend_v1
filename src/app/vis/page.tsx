...
const ChainSelection = ({ polymers }: { polymers: Polymer[] }) => {
  ...
  const filteredOptions: Polymer[] = polymers.filter(
...
export default function Vis() {
  ...
  const [profile_data, setProfileData] = useState<RibosomeStructure | null>(
    null
  );
  ...
  const {
    ...
    isError: structs_overview_Error,
  } = useRoutersRouterStructOverviewQuery();
  ...
  return (
    <div className="flex flex-col h-screen w-screen overflow-hidden">
      ...
      <ResizablePanelGroup
        ...
        className={
          "rounded-lg border " + (test_active ? "bg-black" : "bg-white")
        }
      >
