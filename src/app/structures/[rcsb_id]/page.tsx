...
const TunnelLandmarkComponent: React.FC<{ rcsb_id: string, ctx: MolstarRibxz }> = ({ rcsb_id, ctx }) => {
    ...
    const defaultTunnelActions: LandmarkActions = {
        ...
        render: async (rcsb_id: string, ctx) => { const tunnel_loci = await ctx?.tunnel_geoemetry(rcsb_id); console.log("Returned loci:", tunnel_loci); dispatch(set_tunnel_shape_loci(tunnel_loci)) },
