...
const injectedRtkApi = emptySplitApi
  ...
  .injectEndpoints({
    endpoints: (build) => ({
      ...
      rbxzBendApiV0RouterGetAllStructures: build.query<RbxzBendApiV0RouterGetAllStructuresApiResponse, RbxzBendApiV0RouterGetAllStructuresApiArg>({
        query: () => ({ url: `/get_all_structures` }), providesTags: ["Structure"],
      }),
      rbxzBendApiV0RouterGetStruct: build.query<RbxzBendApiV0RouterGetStructApiResponse, RbxzBendApiV0RouterGetStructApiArg>({
        query: (queryArg) => ({
          url: `/get_struct`,
      ...
      rbxzBendApiV0RouterGetFullStructure: build.query< RbxzBendApiV0RouterGetFullStructureApiResponse, RbxzBendApiV0RouterGetFullStructureApiArg >({
        query: (queryArg) => ({
      ...
      rbxzBendApiV0RouterGetAllLigands: build.query< RbxzBendApiV0RouterGetAllLigandsApiResponse, RbxzBendApiV0RouterGetAllLigandsApiArg >({
        query: () => ({ url: `/get_all_ligands` }),
        providesTags: ["Ligand"],
      }),
      rbxzBendApiV0RouterGetAllLigandlike: build.query< RbxzBendApiV0RouterGetAllLigandlikeApiResponse, RbxzBendApiV0RouterGetAllLigandlikeApiArg >({
        query: () => ({ url: `/get_all_ligandlike` }),
        providesTags: ["Ligand"],
      }),
      rbxzBendApiV0RouterGetRibosomeStructure: build.query< RbxzBendApiV0RouterGetRibosomeStructureApiResponse, RbxzBendApiV0RouterGetRibosomeStructureApiArg >({
        query: (queryArg) => ({
      ...
      rbxzBendApiV0RouterMatchStructsWProteins: build.query< RbxzBendApiV0RouterMatchStructsWProteinsApiResponse, RbxzBendApiV0RouterMatchStructsWProteinsApiArg >({
        query: (queryArg) => ({
      ...
      rbxzBendApiV0RouterGetBanclassForChain: build.query< RbxzBendApiV0RouterGetBanclassForChainApiResponse, RbxzBendApiV0RouterGetBanclassForChainApiArg >({ query: (queryArg) => ({ url: `/get_banclass_for_chain`,
          params: {
